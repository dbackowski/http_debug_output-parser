...
module HttpDebugOutput
  class Parser
    ...
    def parse_request
      ...
      headers = request_lines[1..-1].take_while { |line| line != "" }
      payload = request_lines[headers.count + 1..-1].join('')
    ...
    def parse_response
      ...
      headers = response_lines[1..-1].take_while { |line| !line.start_with?('reading') }
      payload = response_lines[headers.count + 2..-1].join("")
